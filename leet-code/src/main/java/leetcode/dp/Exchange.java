...
public class Exchange {
    ...
    public static int countWays(int[] penny, int n, int aim) {
        ...
        // 记忆搜索
        // 定义中间结果
        // [当前起始Index][当前需要构成的钱数]，这个概念与动态规划的含义不同。类似自顶向下。
        memResult = new int[n][aim + 1];
        for (int i = 0; i < n; i++) {
        ...
        // 基本动态规划
        // 表示的是[0 。。。index种钱][需要组成的钱数]，与记忆搜索不同，这个类似自下而上，规定了计算顺序
        origDpResult = new int[n][aim + 1];
